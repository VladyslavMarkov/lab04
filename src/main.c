...
int main()
{
    ...
    //Перевіряємо чи не більше 90 градусів кути ромба
    if(yy1 > 90 || yy2 > 90 || zz1 > 90 || zz2 > 90)
    {
       printf("Такого ромба не існує");
    }
    //Перевіряємо чи рівні кути ромба які не протилежні
    else if(yy1 == zz1 || yy1 == zz2 || yy2 == zz1 || yy2 == zz2)
    {
       printf("Такого ромба не існує");
    }
    //Перевіряємо, чи не рівні кути ромба 90 градусам
    else if(yy1 == 90 && yy2 == 90 && zz1 == 90 && zz2 == 90 )
    {
       printf("Такого ромба не існує");
    }
    
    //Перевіряємо, чи рівні сторони ромба і чи рівні у нього протилежні кути
